package com.uestc.ui.view.viewpager;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	/**
	 * 返回当前位置,循环时需要注意返回的position包含之前在views�?前方与最后方加入的视图，即当前页面�
	 * ��图在views集合的位�?
	 * 
	 * @return
	 */
	...
	/**
	 * 如果当前页面嵌套在另�?个viewPager中，为了在进行滚动时阻断父ViewPager滚动，可�?
	 * 阻止父ViewPager滑动事件 父ViewPager�?要实现ParentViewPager中的setScrollable方法
	 */
